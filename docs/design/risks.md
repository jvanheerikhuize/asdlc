...
**R2 — Rubber-stamping / automation bias at human gates.** If approvals
...
**R3 — Policy bugs become false assurance.** A wrong Rego policy silently
...
**R4 — The verifier is the supply-chain crown jewel.** Compromise the
...
**R5 — GitHub coupling creep.** Convenience will keep tempting gate logic
...
**R6 — Evidence volume vs. agent context cost.** A high-risk change
...
**R7 — Orchestrator/reality drift.** The cooperative layer's view of the
...
**R8 — Waiver misuse.** Waivers are the designed escape valve and therefore
